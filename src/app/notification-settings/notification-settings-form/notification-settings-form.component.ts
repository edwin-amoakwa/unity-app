...
import { NotificationSetting } from '../notification-settings.service';

@Component({
  selector: 'app-notification-settings-form',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, ButtonModule, InputTextModule, InputSwitchModule],
...
export class NotificationSettingsFormComponent implements OnInit {
  ...
  @Input() value: NotificationSetting | null = null;
  @Output() submitted = new EventEmitter<NotificationSetting>();
